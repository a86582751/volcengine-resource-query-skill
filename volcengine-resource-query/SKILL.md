...
VOLC_BILLING_ENV_FILE=/optional/custom/path.env
```
...
```powershell
python ~/.codex/skills/volcengine-resource-query/scripts/volc_resource_query.py list-packages
```

For Seedance 2.0 Fast quota checks:

```powershell
python ~/.codex/skills/volcengine-resource-query/scripts/volc_resource_query.py seedance-fast-quota --required-tokens 5521745.45
```
